package com.notification.procesador.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Notificacion> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE,
                "com.notification.procesador.domain.Notificacion");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Notificacion>
